...
public class AnalysisResultPackageImpl extends EPackageImpl implements AnalysisResultPackage {
  ...
  {
    return (EAttribute)quantitativeAnalysisResultEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EAttribute)quantitativeAnalysisResultEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
    ...
    createEAttribute(quantitativeAnalysisResultEClass, QUANTITATIVE_ANALYSIS_RESULT__VALUE);
    createEAttribute(quantitativeAnalysisResultEClass, QUANTITATIVE_ANALYSIS_RESULT__LIMIT);
   ...
   */
    ...
    initEAttribute(getQuantitativeAnalysisResult_Value(), ecorePackage.getEFloat(), "value", null, 0, 1, QuantitativeAnalysisResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getQuantitativeAnalysisResult_Limit(), ecorePackage.getEFloat(), "limit", null, 0, 1, QuantitativeAnalysisResult.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
