...
public interface AnalysisResultPackage extends EPackage {
   ...
   * @ordered
   */
  int QUANTITATIVE_ANALYSIS_RESULT__VALUE = ANALYSIS_RESULT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int QUANTITATIVE_ANALYSIS_RESULT__LIMIT = ANALYSIS_RESULT_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
	int QUANTITATIVE_ANALYSIS_RESULT_FEATURE_COUNT = ANALYSIS_RESULT_FEATURE_COUNT + 3;
   ...
   */
	...
	/**
   * Returns the meta object for the containment reference '{@link fr.tpt.aadl.ramses.analysis.AnalysisResult#getSource <em>Source</em>}'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   */
	...
	/**
   * Returns the meta object for the attribute '{@link fr.tpt.aadl.ramses.analysis.QuantitativeAnalysisResult#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Value</em>'.
   * @see fr.tpt.aadl.ramses.analysis.QuantitativeAnalysisResult#getValue()
   * @see #getQuantitativeAnalysisResult()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.tpt.aadl.ramses.analysis.QuantitativeAnalysisResult#getLimit <em>Limit</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Limit</em>'.
   * @see fr.tpt.aadl.ramses.analysis.QuantitativeAnalysisResult#getLimit()
   * @see #getQuantitativeAnalysisResult()
   * @generated
   */
   ...
   */
     ...
     * @generated
     */
    EAttribute QUANTITATIVE_ANALYSIS_RESULT__VALUE = eINSTANCE.getQuantitativeAnalysisResult_Value();
     ...
     * @generated
     */
    EAttribute QUANTITATIVE_ANALYSIS_RESULT__LIMIT = eINSTANCE.getQuantitativeAnalysisResult_Limit();
