...
public class PropertyUtils
{
  ...
  public static PropertyAssociation findProperty(String propertyName,
                                                 NamedElement owner)
  {
   ...
   * @param i component instance.
   * @param propertyName property name.
   * @return property value.
   * @throws Exception thrown if property does not exist or if is not an integer.
   */
  public static long getIntValue(NamedElement i,
                                 String propertyName)
        throws Exception
  {
        ...
        if(values.size() == 1)
        {
          ...
          if(expr instanceof IntegerLiteral)
          {
        	  ...
        	  if (unit != null)
        	  {
        		  ...
        		  {
        			  // XXX: Ms and Bytes are chosen for base units; this is specific for POK
        			  AadlInteger ai = (AadlInteger) pa.getProperty().getPropertyType();
        			  if(ai.getUnitsType().getName().equals("Size_Units"))
        				  unit.setBaseUnit(GetProperties.findUnitLiteral(p, AadlProject.SIZE_UNITS, AadlProject.B_LITERAL));
        			  if(ai.getUnitsType().getName().equals("Time_Units"))
        				  unit.setBaseUnit(GetProperties.findUnitLiteral(p, AadlProject.TIME_UNITS, AadlProject.MS_LITERAL));
        		  }
        		  // Warning: the cast from double to long is licit only if the result of the conversion is an integer 
    ...
    throw new Exception("Property " + propertyName + " not found for " +
          i.getName()) ;
  }

  public static RecordValue getRecordValue(NamedElement i,
                                           String propertyName)
        throws Exception
  {
    PropertyAssociation pa = findProperty(propertyName, i) ;
   ...
   * @throws Exception thrown if property does not exist or if is not an integer.
   */
  public static float getFloatValue(NamedElement i,
                                    String propertyName,
                                    String unit)
        throws Exception
  {
   ...
   * @param propertyName property name.
   * @return property value.
   * @throws Exception thrown if property does not exist or if is not a String.
   */
  public static String getStringValue(NamedElement i,
                                      String propertyName)
        throws Exception
  {
    PropertyAssociation pa = findProperty(propertyName, i) ;
   ...
   * @throws Exception thrown if property does not exist or if is not a String.
   */
  public static List<String> getStringListValue(NamedElement i,
                                                String propertyName)
        throws Exception
  {
              ...
              else if(pe instanceof NamedValue)
              {
                ...
                if(nv.getNamedValue() instanceof EnumerationLiteral)
                {
                  EnumerationLiteral el =
                        (EnumerationLiteral) nv.getNamedValue() ;
                  res.add(el.getName()) ;
                }
              }
            }
   ...
   * @param propertyName property name.
   * @return property value.
   * @throws Exception thrown if property does not exist or if is not an enumeration.
   */
  public static String getEnumValue(NamedElement i,
                                    String propertyName)
        throws Exception
  {
    PropertyAssociation pa = findProperty(propertyName, i) ;
   ...
   * @return property value.
   */
  public static RangeValue getRangeValue(NamedElement i,
                                         String propertyName)
  {
    PropertyAssociation pa = findProperty(propertyName, i) ;
   ...
   * @param propertyName property name.
   * @return property value.
   * @throws Exception thrown if property does not exist or if is not a range.
   */
  public static float getMinRangeValue(NamedElement i,
                                       String propertyName)
        throws Exception
  {
    PropertyAssociation pa = findProperty(propertyName, i) ;
   ...
   * @throws Exception thrown if property does not exist or if is not a range.
   */
  public static float getMaxRangeValue(NamedElement i,
                                       String propertyName)
        throws Exception
  {
    PropertyAssociation pa = findProperty(propertyName, i) ;
                                                            ...
                                                            long value)
  {
    ...
    PropertyAssociation assignment =
          Aadl2Factory.eINSTANCE.createPropertyAssociation() ;
    ModalPropertyValue modalPropertyValue =
          Aadl2Factory.eINSTANCE.createModalPropertyValue() ;
    IntegerLiteral propertyValue =
  ...
  public static boolean setFloatValue(NamedElement e,
                                      String propertyName,
                                      float value)
  {
