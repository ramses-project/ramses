 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.sched.wcetanalysis.result.reducedba.impl.ComputationImpl#getMin <em>Min</em>}</li>
 *   <li>{@link fr.tpt.aadl.sched.wcetanalysis.result.reducedba.impl.ComputationImpl#getMax <em>Max</em>}</li>
 *   <li>{@link fr.tpt.aadl.sched.wcetanalysis.result.reducedba.impl.ComputationImpl#getUnit <em>Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComputationImpl extends ThreadBehaviorElementImpl implements Computation {
	...
	public void setUnit(String newUnit) {
		...
		unit = newUnit;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ReducedbaPackage.COMPUTATION__UNIT, oldUnit, unit));
	}
