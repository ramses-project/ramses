 ...
 * <!-- end-user-doc -->
 * @see fr.tpt.aadl.ramses.constraintsreporter.reporterPackage
 * @generated
 */
public class reporterAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected reporterSwitch<Adapter> modelSwitch =
		new reporterSwitch<Adapter>() {
			@Override
			public Adapter caseError(fr.tpt.aadl.ramses.constraintsreporter.Error object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link fr.tpt.aadl.ramses.constraintsreporter.Error <em>Error</em>}'.
	 * <!-- begin-user-doc -->
