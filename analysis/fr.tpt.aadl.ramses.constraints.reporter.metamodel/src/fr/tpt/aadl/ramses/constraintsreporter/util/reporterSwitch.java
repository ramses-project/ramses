 ...
 * @generated
 */
public class reporterSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case reporterPackage.ERROR: {
				fr.tpt.aadl.ramses.constraintsreporter.Error error = (fr.tpt.aadl.ramses.constraintsreporter.Error)theEObject;
	 ...
	 * @generated
	 */
	public T caseError(fr.tpt.aadl.ramses.constraintsreporter.Error object) {
		return null;
	}
