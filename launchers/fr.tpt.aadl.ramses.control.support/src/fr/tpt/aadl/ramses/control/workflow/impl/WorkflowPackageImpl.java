...
public class WorkflowPackageImpl extends EPackageImpl implements WorkflowPackage {
   ...
   * @generated
   */
	public EAttribute getLoop_InitialAnalysis() {
   ...
   */
    ...
    createEAttribute(loopEClass, LOOP__INITIAL_ANALYSIS);
   ...
   */
    ...
    initEClass(listEClass, fr.tpt.aadl.ramses.control.workflow.List.class, "List", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getList_File(), this.getFile(), null, "file", null, 1, -1, fr.tpt.aadl.ramses.control.workflow.List.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getLoop_Alternatives(), this.getList(), null, "alternatives", null, 2, -1, Loop.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getLoop_InitialAnalysis(), ecorePackage.getEBoolean(), "initialAnalysis", null, 0, 1, Loop.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
