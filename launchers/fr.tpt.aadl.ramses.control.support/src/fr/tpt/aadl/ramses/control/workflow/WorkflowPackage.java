...
public interface WorkflowPackage extends EPackage
{
   ...
   * @ordered
   */
  int TRANSFORMATION__IDENTIFIER = WORKFLOW_ELEMENT_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int LOOP__OUTPUT_MODEL_IDENTIFIER = WORKFLOW_ELEMENT_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int LOOP__FOUND_OPTION = WORKFLOW_ELEMENT_FEATURE_COUNT + 3;
   ...
   * @ordered
   */
  int LOOP__NOT_FOUND_OPTION = WORKFLOW_ELEMENT_FEATURE_COUNT + 4;

  /**
   * The feature id for the '<em><b>Resolution Method</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   ...
   * @see fr.tpt.aadl.ramses.control.workflow.impl.WorkflowPackageImpl#getResolutionMethod()
   * @generated
   */
  int RESOLUTION_METHOD = 17;
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.tpt.aadl.ramses.control.workflow.Transformation#getIdentifier <em>Identifier</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Identifier</em>'.
   * @see fr.tpt.aadl.ramses.control.workflow.Transformation#getIdentifier()
   * @see #getTransformation()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the reference list '{@link fr.tpt.aadl.ramses.control.workflow.Loop#getAlternatives <em>Alternatives</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link fr.tpt.aadl.ramses.control.workflow.Loop#getResolutionMethod <em>Resolution Method</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Resolution Method</em>'.
   * @see fr.tpt.aadl.ramses.control.workflow.Loop#getResolutionMethod()
   * @see #getLoop()
   * @generated
   */
   ...
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for enum '<em>Resolution Method</em>'.
   * @see fr.tpt.aadl.ramses.control.workflow.ResolutionMethod
   * @generated
   */
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute TRANSFORMATION__IDENTIFIER = eINSTANCE.getTransformation_Identifier();
    ...
    /**
     * The meta object literal for the '<em><b>Resolution Method</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
     ...
     * @generated
     */
    EEnum RESOLUTION_METHOD = eINSTANCE.getResolutionMethod();
