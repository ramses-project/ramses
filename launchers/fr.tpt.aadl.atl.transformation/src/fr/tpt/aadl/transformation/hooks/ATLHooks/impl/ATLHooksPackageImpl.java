                                                     ...
                                                     ATLHooksPackage
{
  ...
  public static ATLHooksPackage init()
  {
    if(isInited)
    {
      return (ATLHooksPackage) EPackage.Registry.INSTANCE
            .getEPackage(ATLHooksPackage.eNS_URI) ;
    }

    // Obtain or create and register package
    ATLHooksPackageImpl theATLHooksPackage =
          (ATLHooksPackageImpl) (EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ATLHooksPackageImpl
                                                                                                       ? EPackage.Registry.INSTANCE
                                                                                                             .get(eNS_URI)
                                                                                                       : new ATLHooksPackageImpl()) ;
    isInited = true ;
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(hookAccessEClass, HookAccess.class, "HookAccess", !IS_ABSTRACT,
               !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS) ;
    EOperation op =
          addEOperation(hookAccessEClass, theAadlBaPackage.getBehaviorAnnex(),
                        "createBehaviorAnnex", 1, 1, IS_UNIQUE, IS_ORDERED) ;
    addEParameter(op, theAadl2Package.getThreadImplementation(), "threadImpl",
                  1, 1, IS_UNIQUE, IS_ORDERED) ;
    op =
          addEOperation(hookAccessEClass, null, "setDirectionIn", 0, 1,
                        IS_UNIQUE, IS_ORDERED) ;
    addEParameter(op, theAadl2Package.getDirectedFeature(), "feature", 1, 1,
                  IS_UNIQUE, IS_ORDERED) ;
    op =
          addEOperation(hookAccessEClass, null, "resolveBANames", 0, 1,
                        IS_UNIQUE, IS_ORDERED) ;
    addEParameter(op, theAadlBaPackage.getBehaviorAnnex(), "ba", 1, 1,
                  IS_UNIQUE, IS_ORDERED) ;
    op =
          addEOperation(hookAccessEClass, theAadl2Package.getFeature(),
                        "orderFeatures", 0, -1, IS_UNIQUE, IS_ORDERED) ;
    addEParameter(op, theAadl2Package.getComponentType(), "cpt", 0, 1,
                  IS_UNIQUE, IS_ORDERED) ;
    op =
          addEOperation(hookAccessEClass, null, "copyLocationReference", 0, 1,
                        IS_UNIQUE, IS_ORDERED) ;
    addEParameter(op, theAadl2Package.getElement(), "target", 1, 1, IS_UNIQUE,
                  IS_ORDERED) ;
    addEParameter(op, theAadl2Package.getElement(), "source", 1, 1, IS_UNIQUE,
                  IS_ORDERED) ;
    // Create resource
