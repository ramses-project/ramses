...
public class AtlHooksAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected AtlHooksSwitch<Adapter> modelSwitch =
    new AtlHooksSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.tpt.aadl.ramses.transformation.atl.hooks.HookAccess <em>Hook Access</em>}'.
   * <!-- begin-user-doc -->
