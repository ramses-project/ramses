...
public class SensitivityBasedManagerFactory implements LoopManagerFactory
{

  @Override
  public LoopManager createLoopManager(AadlTargetSpecificGenerator generator,
                                       AbstractLoop l,
  ...
  {
    return new SensitivityBasedSelection(generator,
                                         l, 
                                         errManager, 
                                         workflowPilot, 
                                         config, 
