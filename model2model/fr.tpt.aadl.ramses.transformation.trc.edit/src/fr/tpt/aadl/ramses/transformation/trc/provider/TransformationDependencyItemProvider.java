...
public class TransformationDependencyItemProvider
  ...
  public String getText(Object object) {
    String label = ((TransformationDependency)object).getAppliedRule();
    return label == null || label.length() == 0 ?
      getString("_UI_TransformationDependency_type") :
      getString("_UI_TransformationDependency_type") + " " + label;
  }
