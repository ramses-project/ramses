...
/**
 * This is the item provider adapter for a {@link fr.tpt.aadl.ramses.transformation.trc.Transformation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Transformation_ruleName_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Transformation_ruleName_feature", "_UI_Transformation_type"),
         TrcPackage.Literals.TRANSFORMATION__RULE_NAME,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         TrcPackage.Literals.TRANSFORMATION__NAME,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
