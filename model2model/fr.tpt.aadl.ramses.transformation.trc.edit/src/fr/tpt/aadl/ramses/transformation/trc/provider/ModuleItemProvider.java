	...
	protected void addRulesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Module_rules_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Module_rules_feature", "_UI_Module_type"),
				 TrcPackage.Literals.MODULE__RULES,
				 true,
				 false,
				 true,
				 null,
