...
/**
 * This is the item provider adapter for a {@link fr.tpt.aadl.ramses.transformation.trc.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         TrcPackage.Literals.MODULE__NAME,
         true,
         false,
         false,
  ...
  protected void addRuleNamePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Module_ruleName_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Module_ruleName_feature", "_UI_Module_type"),
         TrcPackage.Literals.MODULE__RULE_NAME,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  protected void addPathPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Module_path_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Module_path_feature", "_UI_Module_type"),
         TrcPackage.Literals.MODULE__PATH,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
  ...
  public void notifyChanged(Notification notification) {
    ...
    switch (notification.getFeatureID(Module.class))
    {
      ...
      case TrcPackage.MODULE__RULE_NAME:
