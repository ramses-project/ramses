	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RuleDependency_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RuleDependency_type_feature", "_UI_RuleDependency_type"),
				 TrcPackage.Literals.RULE_DEPENDENCY__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
