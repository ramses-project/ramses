 ...
 *   <li>{@link fr.tpt.aadl.ramses.transformation.trc.impl.ModuleImpl#getRuleName <em>Rule Name</em>}</li>
...
public class ModuleImpl extends EObjectImpl implements Module
{
  ...
  public EList<String> getRuleName()
  {
    if (ruleName == null)
    {
      ruleName = new EDataTypeUniqueEList<String>(String.class, this, TrcPackage.MODULE__RULE_NAME);
    }
    return ruleName;
  }
