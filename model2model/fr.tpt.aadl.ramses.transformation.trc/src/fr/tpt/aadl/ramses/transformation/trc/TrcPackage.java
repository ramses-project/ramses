...
public interface TrcPackage extends EPackage
{
  ...
  /**
	 * The feature id for the '<em><b>Required Transformations</b></em>' containment reference.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 * @ordered
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int RULE_DEPENDENCY__IS_EXCLUSION = ABSTRACT_RULE_DEPENDENCY_FEATURE_COUNT + 3;
  ...
  /**
	 ...
	 * @ordered
	 */
	int RULE_DEPENDENCY__TYPE = ABSTRACT_RULE_DEPENDENCY_FEATURE_COUNT + 4;

		/**
	 * The feature id for the '<em><b>Required Rule</b></em>' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RULE_DEPENDENCY__REQUIRED_RULE = ABSTRACT_RULE_DEPENDENCY_FEATURE_COUNT + 5;
   ...
   * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
  int RULE_DEPENDENCY_FEATURE_COUNT = ABSTRACT_RULE_DEPENDENCY_FEATURE_COUNT + 6;
  ...
  /**
	 * The meta object id for the '{@link fr.tpt.aadl.ramses.transformation.trc.impl.TrcRuleImpl <em>Rule</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see fr.tpt.aadl.ramses.transformation.trc.impl.TrcRuleImpl
	 * @see fr.tpt.aadl.ramses.transformation.trc.impl.TrcPackageImpl#getTrcRule()
	 * @generated
	 */
	int TRC_RULE = 15;
  ...
  /**
	 * Returns the meta object for the containment reference list '{@link fr.tpt.aadl.ramses.transformation.trc.Module#getRules <em>Rules</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Rules</em>'.
	 * @see fr.tpt.aadl.ramses.transformation.trc.Module#getRules()
	 * @see #getModule()
	 * @generated
	 */
  ...
  /**
	 * Returns the meta object for the containment reference '{@link fr.tpt.aadl.ramses.transformation.trc.TransformationDependency#getRequiredTransformations <em>Required Transformations</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Required Transformations</em>'.
  ...
  /**
	 * Returns the meta object for the reference '{@link fr.tpt.aadl.ramses.transformation.trc.TransformationDependency#getAppliedRule <em>Applied Rule</em>}'.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
	 * Returns the meta object for the attribute '{@link fr.tpt.aadl.ramses.transformation.trc.RuleDependency#getType <em>Type</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Type</em>'.
	 * @see fr.tpt.aadl.ramses.transformation.trc.RuleDependency#getType()
	 * @see #getRuleDependency()
	 * @generated
	 */
	EAttribute getRuleDependency_Type();
		...
		/**
	 * Returns the meta object for the reference '{@link fr.tpt.aadl.ramses.transformation.trc.RuleDependency#getRequiredRule <em>Required Rule</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Required Rule</em>'.
  ...
  /**
	 * Returns the meta object for class '{@link fr.tpt.aadl.ramses.transformation.trc.TrcRule <em>Rule</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	EClass getTrcRule();
		...
		/**
	 * Returns the meta object for the attribute '{@link fr.tpt.aadl.ramses.transformation.trc.TrcRule#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see fr.tpt.aadl.ramses.transformation.trc.TrcRule#getName()
	 * @see #getTrcRule()
	 * @generated
	 */
	EAttribute getTrcRule_Name();
		...
		/**
	 * Returns the meta object for the reference '{@link fr.tpt.aadl.ramses.transformation.trc.TrcRule#getSuperRule <em>Super Rule</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Super Rule</em>'.
	 * @see fr.tpt.aadl.ramses.transformation.trc.TrcRule#getSuperRule()
	 * @see #getTrcRule()
	 * @generated
	 */
	EReference getTrcRule_SuperRule();
		...
		/**
	 * Returns the meta object for the attribute '{@link fr.tpt.aadl.ramses.transformation.trc.TrcRule#isIsAbstract <em>Is Abstract</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Is Abstract</em>'.
	 * @see fr.tpt.aadl.ramses.transformation.trc.TrcRule#isIsAbstract()
	 * @see #getTrcRule()
	 * @generated
	 */
  ...
  interface Literals
  {
    ...
    /**
		 * The meta object literal for the '<em><b>Required Transformations</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
		 * @generated
		 */
    ...
    /**
		 ...
		 * @generated
		 */
		EAttribute RULE_DEPENDENCY__TYPE = eINSTANCE.getRuleDependency_Type();

				/**
		 * The meta object literal for the '<em><b>Required Rule</b></em>' reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RULE_DEPENDENCY__REQUIRED_RULE = eINSTANCE.getRuleDependency_RequiredRule();
    ...
    EReference TRANSFORMATION_DEPENDENCY_LIST__TRANSFORMATION_DEPENDENCIES = eINSTANCE.getTransformationDependencyList_TransformationDependencies();
				...
				/**
		 * The meta object literal for the '{@link fr.tpt.aadl.ramses.transformation.trc.impl.TrcRuleImpl <em>Rule</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see fr.tpt.aadl.ramses.transformation.trc.impl.TrcRuleImpl
		 * @see fr.tpt.aadl.ramses.transformation.trc.impl.TrcPackageImpl#getTrcRule()
		 ...
		 * @generated
		 */
		EReference TRC_RULE__SUPER_RULE = eINSTANCE.getTrcRule_SuperRule();
		 ...
		 * @generated
		 */
		EAttribute TRC_RULE__IS_ABSTRACT = eINSTANCE.getTrcRule_IsAbstract();
