...
public class GraphAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected GraphSwitch<Adapter> modelSwitch =
    new GraphSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseDependencyArc(DependencyArc object)
      {
        return createDependencyArcAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.tpt.aadl.ramses.transformation.selection.dependency.graph.graph.DependencyGraph <em>Dependency Graph</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.tpt.aadl.ramses.transformation.selection.dependency.graph.graph.DependencyNode <em>Dependency Node</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link fr.tpt.aadl.ramses.transformation.selection.dependency.graph.graph.DependencyArc <em>Dependency Arc</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createDependencyArcAdapter()
  {
    return null;
  }
