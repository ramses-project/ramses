...
public class TrcPackageImpl extends EPackageImpl implements TrcPackage
{
  ...
  /**
	...
	public EReference getRuleDependency_RequiredRule() {
		return (EReference)ruleDependencyEClass.getEStructuralFeatures().get(5);
	}
  ...
  /**
	...
	public EReference getTrcRule_SuperRule() {
		return (EReference)trcRuleEClass.getEStructuralFeatures().get(1);
	}
	...
	public EAttribute getTrcRule_IsAbstract() {
		return (EAttribute)trcRuleEClass.getEStructuralFeatures().get(2);
	}
  ...
  public void createPackageContents()
  {
		...
		createEAttribute(ruleDependencyEClass, RULE_DEPENDENCY__TYPE);
		createEReference(ruleDependencyEClass, RULE_DEPENDENCY__REQUIRED_RULE);
		...
		createEReference(trcRuleEClass, TRC_RULE__SUPER_RULE);
		createEAttribute(trcRuleEClass, TRC_RULE__IS_ABSTRACT);
	}
  ...
  public void initializePackageContents()
  {
		...
		initEAttribute(getRuleDependency_Type(), ecorePackage.getEString(), "type", null, 1, 1, RuleDependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRuleDependency_RequiredRule(), this.getTrcRule(), null, "requiredRule", null, 1, 1, RuleDependency.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		addEOperation(ruleDependencyEClass, ecorePackage.getEBoolean(), "isExclusion", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getTrcRule_SuperRule(), this.getTrcRule(), null, "superRule", null, 0, 1, TrcRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTrcRule_IsAbstract(), ecorePackage.getEBoolean(), "isAbstract", null, 0, 1, TrcRule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
