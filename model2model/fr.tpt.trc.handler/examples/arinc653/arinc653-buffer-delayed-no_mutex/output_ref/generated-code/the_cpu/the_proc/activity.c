...
{
  while (1) {
    test_buffer_delayed_refined_model__the_proc_the_sender_entrypoint_impl (&the_receiver_p_in_globalVariable);
  }
  return 0;
}
extern test_buffer_delayed_refined_model__bufferArrayImpl_the_receiver_p_in_impl the_receiver_p_in_globalVariable;
...
{
  while (1) {
    test_buffer_delayed_refined_model__the_proc_the_receiver_entrypoint_impl (&the_receiver_p_in_globalVariable);
  }
  return 0;
}
