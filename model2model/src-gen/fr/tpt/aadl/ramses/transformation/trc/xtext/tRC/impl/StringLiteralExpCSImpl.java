 ...
 * <ul>
 *   <li>{@link fr.tpt.aadl.ramses.transformation.trc.xtext.tRC.impl.StringLiteralExpCSImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralExpCSImpl extends PrimitiveLiteralExpCSImpl implements StringLiteralExpCS
{
  ...
  {
    return TRCPackage.Literals.STRING_LITERAL_EXP_CS;
  }
  ...
  public EList<String> getName()
  {
    if (name == null)
    {
      name = new EDataTypeEList<String>(String.class, this, TRCPackage.STRING_LITERAL_EXP_CS__NAME);
    }
    return name;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TRCPackage.STRING_LITERAL_EXP_CS__NAME:
        return getName();
    }
