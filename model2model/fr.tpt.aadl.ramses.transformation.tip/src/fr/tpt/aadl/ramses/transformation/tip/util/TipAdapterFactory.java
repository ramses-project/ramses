...
public class TipAdapterFactory extends AdapterFactoryImpl {
   ...
   * @generated
   */
	protected TipSwitch modelSwitch =
		new TipSwitch()
    {
      public Object caseTipSpecification(TipSpecification object)
      {
        return createTipSpecificationAdapter();
      }
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link fr.tpt.aadl.ramses.transformation.tip.TipSpecification <em>Specification</em>}'.
   * <!-- begin-user-doc -->
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link fr.tpt.aadl.ramses.transformation.tip.Iteration <em>Iteration</em>}'.
   * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link fr.tpt.aadl.ramses.transformation.tip.ElementTransformation <em>Element Transformation</em>}'.
   * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
