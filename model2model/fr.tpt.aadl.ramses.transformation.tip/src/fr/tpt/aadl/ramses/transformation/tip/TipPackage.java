...
public interface TipPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ELEMENT_TRANSFORMATION__TRANSFORMATION_ID = 0;
	 ...
	 * @ordered
	 */
	int ELEMENT_TRANSFORMATION__ELEMENT_ID = 1;
	 ...
	 * @ordered
	 */
	int ELEMENT_TRANSFORMATION__ELEMENT_NAME = 2;
	 ...
	 * @ordered
	 */
	int ELEMENT_TRANSFORMATION__IS_EXCLUSION = 3;
