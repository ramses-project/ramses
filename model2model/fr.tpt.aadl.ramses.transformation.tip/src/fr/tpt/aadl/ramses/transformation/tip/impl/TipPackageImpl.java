...
public class TipPackageImpl extends EPackageImpl implements TipPackage {
   ...
   */
    ...
    return (EAttribute)elementTransformationEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
    ...
    initEReference(getElementTransformation_ElementId(), theAadl2Package.getElement(), null, "elementId", null, 1, -1, ElementTransformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
