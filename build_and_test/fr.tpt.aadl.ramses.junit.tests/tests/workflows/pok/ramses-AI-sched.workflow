...
<rwf:Workflow xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:rwf="http://fr.tpt.aadl.ramses.control.workflow/Ramses/1.0">
  <element xsi:type="rwf:Transformation" inputModelIdentifier="//@inputModelIdentifier" identifier="pok">
    <element xsi:type="rwf:Analysis" inputModelIdentifier="//@element/@outputModelIdentifier" method="AADLInspector-SchedulingAnalysis" mode="manual">
      <yesOption>
