...
while(1)
{
  switch(S2_inst_a2_inst_entrypoint_impl_current_state)
  {
    ...
    if(whichPortActivated == PingPong_refined_model__S2_inst_a2_inst_behaviorIdentifier_enum_default_behavior)
    {
      ...
      mode (&PingPong_a2_impl_call_seq_PingPong_IPingOrPong_mode_seqNb_entrypoint, PingPong_refined_model__S2_inst_a2_inst_entrypoint_impl_C2_PingIn_localVariable, &PingPong_refined_model__S2_inst_a2_inst_entrypoint_impl_C2_PingOut_localVariable, PingPong_refined_model__S2_inst_a2_inst_entrypoint_impl_C2_PongIn_localVariable, &PingPong_refined_model__S2_inst_a2_inst_entrypoint_impl_C2_PongOut_localVariable, &PingPong_refined_model__S2_inst_a2_inst_entrypoint_impl_C2_badSequenceNumber_localVariable, PingPong_refined_model__S2_inst_a2_inst_entrypoint_impl_C2_mode_localVariable);
      }
