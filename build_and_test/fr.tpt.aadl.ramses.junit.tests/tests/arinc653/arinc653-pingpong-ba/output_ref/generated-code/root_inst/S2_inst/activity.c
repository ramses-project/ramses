...
void* PingPong_refined_model__S2_inst_IPingOrPong_Cping_ping_impl_Job()
{
  ...
  PingPong_refined_model__S2_inst_IPingOrPong_Cping_ping_entrypoint_impl (&IPingOrPong_Cping_ping_delayed_PongIn_globalVariable, &S2_inst_C2_PingOut_globalVariable, &S2_inst_C2_badSequenceNumber_globalVariable, &S2_inst_C2_modeglobalVariable, &seqNb, &IPingOrPong_Cping_pingParent_BA_currentState, &PingPong_refined_model__S2_inst_IPingOrPong_Cping_ping_impl_PingOut_persistentFreshnessIndicator);
  return 0;
}
extern SEQ seqNb;
...
{
  PingPong_refined_model__S2_inst_IPingOrPong_Cping_delayed_PongIn_entrypoint_impl (&S2_inst_C2_PongInglobalVariable, &IPingOrPong_Cping_ping_delayed_PongIn_globalVariable, &S2_inst_C2_modeglobalVariable, &seqNb, &IPingOrPong_Cping_delayed_PongInParent_BA_currentState);
  return 0;
}
extern SEQ seqNb;
...
void* PingPong_refined_model__S2_inst_IPingOrPong_Cpong_pong_impl_Job()
{
  ...
  PingPong_refined_model__S2_inst_IPingOrPong_Cpong_pong_entrypoint_impl (&S2_inst_C2_PingInglobalVariable, &S2_inst_C2_PongOut_globalVariable, &S2_inst_C2_modeglobalVariable, &seqNb, &IPingOrPong_Cpong_pongParent_BA_currentState, &PingPong_refined_model__S2_inst_IPingOrPong_Cpong_pong_impl_PingIn_persistentFreshnessIndicator);
  return 0;
}
