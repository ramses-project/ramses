...
typedef enum e_PingPong_refined_model__S1_inst_Monitor_delayed_error_C2_currentState {
	PingPong_refined_model__S1_inst_Monitor_delayed_error_C2_currentState_switch
} PingPong_refined_model__S1_inst_Monitor_delayed_error_C2_currentState;
...
typedef enum e_PingPong_refined_model__S1_inst_IPingOrPong_Cping_ping_currentState {
	PingPong_refined_model__S1_inst_IPingOrPong_Cping_ping_currentState_switch
} PingPong_refined_model__S1_inst_IPingOrPong_Cping_ping_currentState;
...
typedef enum e_PingPong_refined_model__S1_inst_IPingOrPong_Cping_delayed_PongIn_currentState {
	PingPong_refined_model__S1_inst_IPingOrPong_Cping_delayed_PongIn_currentState_switch
...
typedef enum e_PingPong_refined_model__S1_inst_IPingOrPong_Cpong_pong_currentState {
	PingPong_refined_model__S1_inst_IPingOrPong_Cpong_pong_currentState_switch
} PingPong_refined_model__S1_inst_IPingOrPong_Cpong_pong_currentState;
