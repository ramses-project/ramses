...
int main ()
{
test_buffer_refined_model__the_proc_the_sender_impl_Init();
test_buffer_refined_model__the_proc_the_receiver_impl_Init();
  ...
  tattr.ENTRY_POINT = test_buffer_refined_model__the_proc_the_sender_impl_Job;
  tattr.PERIOD = 2000;
  tattr.DEADLINE = 2000;
  ...
  tattr.ENTRY_POINT = test_buffer_refined_model__the_proc_the_receiver_impl_Job;
  tattr.PERIOD = 1000;
  tattr.DEADLINE = 1000;
  tattr.TIME_CAPACITY = 1;
