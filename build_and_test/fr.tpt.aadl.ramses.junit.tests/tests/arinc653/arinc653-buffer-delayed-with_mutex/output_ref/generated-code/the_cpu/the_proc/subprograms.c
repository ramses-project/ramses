...
test_buffer_delayed_refined_model__root_impl_Instance_the_proc_the_receiver_p_in_Init_Spg_BA_State_t root_impl_Instance_the_proc_the_receiver_p_in_Init_Spg_current_state = test_buffer_delayed_refined_model__root_impl_Instance_the_proc_the_receiver_p_in_Init_Spg_s;
...
while(1)
{
  switch(root_impl_Instance_the_proc_the_receiver_p_in_Init_Spg_current_state)
  {
    case test_buffer_delayed_refined_model__root_impl_Instance_the_proc_the_receiver_p_in_Init_Spg_s:
    // Transition id: t
    if(1) // no execution condition
    {
      root_impl_Instance_the_proc_the_receiver_p_in_Init_Spg_current_state = test_buffer_delayed_refined_model__root_impl_Instance_the_proc_the_receiver_p_in_Init_Spg_s;
