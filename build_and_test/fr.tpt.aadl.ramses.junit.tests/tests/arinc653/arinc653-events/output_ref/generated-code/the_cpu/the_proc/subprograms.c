...
void test_events_refined_model__the_proc_the_sender_entrypoint_impl(BUFFER_ID_TYPE *  cnx_p_out)
{
  ...
  MESSAGE_SIZE_TYPE test_events_refined_model__the_proc_the_sender_entrypoint_impl_p_out_Length = sizeof(Base_Types__Integer_16);
  SYSTEM_TIME_TYPE test_events_refined_model__the_proc_the_sender_entrypoint_impl_p_out_TimeOut = 0;
...
while(1)
{
  switch(the_proc_the_sender_entrypoint_impl_current_state)
  {
    ...
    if(whichPortActivated == test_events_refined_model__the_proc_the_sender_behaviorIdentifier_enum_default_behavior)
    {
      ...
      send_event ();
      SEND_BUFFER ((*cnx_p_out), &test_events_refined_model__the_proc_the_sender_entrypoint_impl_p_out_localVariable, test_events_refined_model__the_proc_the_sender_entrypoint_impl_p_out_Length, test_events_refined_model__the_proc_the_sender_entrypoint_impl_p_out_TimeOut, &test_events_refined_model__the_proc_the_sender_entrypoint_impl_the_proc_the_sender_runtime_call_ret);
      break;
    }
  }
}
...
void test_events_refined_model__the_proc_the_receiver_entrypoint_impl(BUFFER_ID_TYPE *  p_in)
{
...
while(1)
{
  switch(the_proc_the_receiver_entrypoint_impl_current_state)
  {
    ...
    {
      the_proc_the_receiver_entrypoint_impl_current_state = test_events_refined_model__the_proc_the_receiver_entrypoint_impl_BA_entrypoint_exec_state;
      PERIODIC_WAIT (&test_events_refined_model__the_proc_the_receiver_entrypoint_impl_the_proc_the_receiver_runtime_call_ret);
