...
typedef enum {
  ...
  test_osek_eventdataports_refined_model__the_proc1_the_sender_entrypoint_impl_BA_entrypoint_wait_dispatch_state,
  test_osek_eventdataports_refined_model__the_proc1_the_sender_entrypoint_impl_BA_entrypoint_exec_state,
...
typedef enum {
  ...
  test_osek_eventdataports_refined_model__the_proc1_the_receiver_entrypoint_impl_BA_entrypoint_wait_dispatch_state,
  test_osek_eventdataports_refined_model__the_proc1_the_receiver_entrypoint_impl_BA_entrypoint_exec_state,
  test_osek_eventdataports_refined_model__the_proc1_the_receiver_entrypoint_impl_BA_entrypoint_final_state
} test_osek_eventdataports_refined_model__the_proc1_the_receiver_entrypoint_impl_BA_State_t;
