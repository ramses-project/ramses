...
void test_osek_modes_modes_refined_refined_model__the_proc_modes_the_sender_entrypoint_impl(
	thread_queue_t *  m1_the_sender_p_m2_p,
	thread_queue_t *  m2_the_sender_p_m1_p)
{
...
void test_osek_modes_modes_refined_refined_model__the_proc_modes_the_receiver_entrypoint_impl(
	data_port_t *  input_data_m1,
	data_port_t *  input_data_m2)
{
...
void test_osek_modes_modes_refined_refined_model__the_proc_modes_the_receiver_m2_entrypoint_impl(
	data_port_t *  input_data_m2)
{
...
void test_osek_modes_modes_refined_refined_model__the_proc_modes_the_proc_modes_mode_m1_entrypoint_impl(
	...
	test_osek_modes_modes_refined_refined_model__the_proc_modes_the_proc_modes_mode_m1_currentState *  Parent_BA_currentState_Access)
{
