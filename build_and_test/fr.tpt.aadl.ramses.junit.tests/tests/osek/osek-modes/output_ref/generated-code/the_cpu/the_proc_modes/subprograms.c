...
while(1)
{
  switch(the_proc_modes_the_receiver_m1_entrypoint_impl_current_state)
  {
    ...
    if(whichPortActivated == test_osek_modes_modes_refined_refined_model__the_proc_modes_the_receiver_m1_behaviorIdentifier_enum_default_behavior)
    {
      ...
      test_osek_modes_modes_refined_refined_model__the_proc_modes_the_receiver_m1_entrypoint_impl_input_data_ErrorCode = GetValueDataPort_runtime (input_data, &test_osek_modes_modes_refined_refined_model__the_proc_modes_the_receiver_m1_entrypoint_impl_input_data_localVariable);
...
while(1)
{
  switch(the_proc_modes_the_receiver_m2_entrypoint_impl_current_state)
  {
    ...
    if(whichPortActivated == test_osek_modes_modes_refined_refined_model__the_proc_modes_the_receiver_m2_behaviorIdentifier_enum_default_behavior)
    {
      ...
      test_osek_modes_modes_refined_refined_model__the_proc_modes_the_receiver_m2_entrypoint_impl_input_data_ErrorCode = GetValueDataPort_runtime (input_data, &test_osek_modes_modes_refined_refined_model__the_proc_modes_the_receiver_m2_entrypoint_impl_input_data_localVariable);
