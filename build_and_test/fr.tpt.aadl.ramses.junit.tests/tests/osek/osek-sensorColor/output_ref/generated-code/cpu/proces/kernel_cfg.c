/*
 *  kernel_cfg.c
 *  Tue Feb 03 13:39:55 2015
 *  SG Version 2.00
 *  sg.exe ./proces.oil -os=ECC2 -I/opt/sandbox/nxtOSEK-ramses/ecrobot/../toppers_osek/sg/impl_oil -template=/opt/sandbox/nxtOSEK-ramses/ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
...
extern void TASKNAME( bg )( void );

static __STK_UNIT _stack_th[__TCOUNT_STK_UNIT(512)];
static __STK_UNIT _stack_bg[__TCOUNT_STK_UNIT(512)];
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( th ), TASKNAME( bg ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_th, (__STK_UNIT)_stack_bg, };
...
const AlarmType wakeUpth_default_mode = 0;
const AlarmType wakeUpbg_default_mode = 1;

DeclareTask(th);
static void _activate_alarm_wakeUpth_default_mode( void );
static void _activate_alarm_wakeUpth_default_mode( void )
{ (void)ActivateTask( th ); }

DeclareTask(bg);
static void _activate_alarm_wakeUpbg_default_mode( void );
static void _activate_alarm_wakeUpbg_default_mode( void )
{ (void)ActivateTask( bg ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_wakeUpth_default_mode, _activate_alarm_wakeUpbg_default_mode, };
const AppModeType alminib_autosta[TNUM_ALARM] = { 0x00000001, 0x00000001, };
const TickType alminib_almval[TNUM_ALARM] = { 1, 1, };
const TickType alminib_cycle[TNUM_ALARM] = { 100, 10, };
