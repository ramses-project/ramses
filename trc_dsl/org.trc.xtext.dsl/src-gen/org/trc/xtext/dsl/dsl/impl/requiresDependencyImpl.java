...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>requires Dependency</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.trc.xtext.dsl.dsl.impl.requiresDependencyImpl#getRequiredTransformation <em>Required Transformation</em>}</li>
 *   <li>{@link org.trc.xtext.dsl.dsl.impl.requiresDependencyImpl#getRequiredRule <em>Required Rule</em>}</li>
 *   <li>{@link org.trc.xtext.dsl.dsl.impl.requiresDependencyImpl#getFields <em>Fields</em>}</li>
 *   <li>{@link org.trc.xtext.dsl.dsl.impl.requiresDependencyImpl#getOclExpression <em>Ocl Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class requiresDependencyImpl extends MinimalEObjectImpl.Container implements requiresDependency
{
  /**
   ...
   * @generated
   */
  protected requiresDependencyImpl()
  {
    super();
  }
  ...
  {
    return DslPackage.Literals.REQUIRES_DEPENDENCY;
  }
  ...
  public EList<Transformation> getRequiredTransformation()
  {
    ...
    {
      requiredTransformation = new EObjectResolvingEList<Transformation>(Transformation.class, this, DslPackage.REQUIRES_DEPENDENCY__REQUIRED_TRANSFORMATION);
    }
  ...
  public void setRequiredRule(String newRequiredRule)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.REQUIRES_DEPENDENCY__REQUIRED_RULE, oldRequiredRule, requiredRule));
  }
  ...
  public void setFields(String newFields)
  {
    ...
    fields = newFields;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.REQUIRES_DEPENDENCY__FIELDS, oldFields, fields));
  }
  ...
  public void setOclExpression(String newOclExpression)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.REQUIRES_DEPENDENCY__OCL_EXPRESSION, oldOclExpression, oclExpression));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.REQUIRES_DEPENDENCY__REQUIRED_TRANSFORMATION:
        return getRequiredTransformation();
      case DslPackage.REQUIRES_DEPENDENCY__REQUIRED_RULE:
        return getRequiredRule();
      case DslPackage.REQUIRES_DEPENDENCY__FIELDS:
        return getFields();
      case DslPackage.REQUIRES_DEPENDENCY__OCL_EXPRESSION:
