	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getTransformationDependencyAccess().getAlternatives_13(), "rule__TransformationDependency__Alternatives_13");
					...
					put(grammarAccess.getModuleListAccess().getGroup_3_1(), "rule__ModuleList__Group_3_1__0");
					put(grammarAccess.getModulesAccess().getGroup(), "rule__Modules__Group__0");
					put(grammarAccess.getModulesAccess().getGroup_5(), "rule__Modules__Group_5__0");
					...
					put(grammarAccess.getTrcSpecificationAccess().getFromsAssignment_0(), "rule__TrcSpecification__FromsAssignment_0");
					put(grammarAccess.getTrcSpecificationAccess().getModuleListAssignment_1(), "rule__TrcSpecification__ModuleListAssignment_1");
					put(grammarAccess.getTrcSpecificationAccess().getTransformationListAssignment_2(), "rule__TrcSpecification__TransformationListAssignment_2");
					put(grammarAccess.getTrcSpecificationAccess().getDependencyListAssignment_3(), "rule__TrcSpecification__DependencyListAssignment_3");
					put(grammarAccess.getFromAccess().getImportURIAssignment_1(), "rule__From__ImportURIAssignment_1");
					put(grammarAccess.getRulesAccess().getNameAssignment(), "rule__Rules__NameAssignment");
					put(grammarAccess.getModuleListAccess().getModulesAssignment_3_0(), "rule__ModuleList__ModulesAssignment_3_0");
					put(grammarAccess.getModuleListAccess().getModulesAssignment_3_1_1(), "rule__ModuleList__ModulesAssignment_3_1_1");
					put(grammarAccess.getModulesAccess().getPathAssignment_0(), "rule__Modules__PathAssignment_0");
					put(grammarAccess.getModulesAccess().getNameAssignment_2(), "rule__Modules__NameAssignment_2");
					put(grammarAccess.getModulesAccess().getRuleNameAssignment_4(), "rule__Modules__RuleNameAssignment_4");
					put(grammarAccess.getModulesAccess().getRuleNameAssignment_5_1(), "rule__Modules__RuleNameAssignment_5_1");
					...
					put(grammarAccess.getRuleDependencyConjunctionAccess().getRequiredTransformationsAssignment_1(), "rule__RuleDependencyConjunction__RequiredTransformationsAssignment_1");
					put(grammarAccess.getRuleDependencyConjunctionAccess().getRequiredTransformationsAssignment_3(), "rule__RuleDependencyConjunction__RequiredTransformationsAssignment_3");
					put(grammarAccess.getRuleDependencyDisjunctionAccess().getRequiredTransformationsAssignment_1(), "rule__RuleDependencyDisjunction__RequiredTransformationsAssignment_1");
					put(grammarAccess.getRuleDependencyDisjunctionAccess().getRequiredTransformationsAssignment_3(), "rule__RuleDependencyDisjunction__RequiredTransformationsAssignment_3");
