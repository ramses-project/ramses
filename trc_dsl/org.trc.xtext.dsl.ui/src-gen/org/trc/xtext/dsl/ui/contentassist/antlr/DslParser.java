		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getModuleAccess().getRulesAssignment_2(), "rule__Module__RulesAssignment_2");
					put(grammarAccess.getModuleAccess().getRulesAssignment_3_1(), "rule__Module__RulesAssignment_3_1");
