...
public class AadlArinc653TTTransformation implements
                                       AadlToTargetSpecificAadl
{
                                                      ...
                                                      throws GenerationException
  {
    try
    {
      ...
      System.out.println("Expansion n°1: Delayed connections (resource: " + inputResource.getURI().path()+")");
      Resource r1 = transform(inputResource,resourceFilePath,standardPropertySets,generatedFilePath, ATL_FILE_NAMES_STEP1);
      
      System.out.println("Expansion n°2: Threads behavior (resource: " + r1.getURI().path()+")");
      
      Resource r2 = transform(r1,resourceFilePath,standardPropertySets,generatedFilePath, ATL_FILE_NAMES_STEP2);
  ...
  private Resource transform(Resource inputResource,
          File resourceFilePath,
          Map<String, Resource> standardPropertySets,
          File generatedFilePath,
          final String[] modules) throws Exception
  {
      ...
      aadlGeneratedFileName = aadlGeneratedFileName.replaceFirst(".aaxl2","_extended.aadl2") ;
