...
public class AadlToAdaMakefileUnparser extends AadlProcessingSwitch
implements TargetBuilderGenerator
{
	...
	protected void initSwitches()
	{
		aadl2Switch = new Aadl2Switch<String>()
			...
			{
				unparserContent.addOutputNewline("GNAT_BIN = /usr/bin") ;
				unparserContent.addOutputNewline("GCC      = $(GNAT_BIN)/gcc") ;
				unparserContent.addOutputNewline("GNATMAKE = $(GNAT_BIN)/gnatmake") ;
				unparserContent.addOutputNewline("GNATBIND = $(GNAT_BIN)/gnatbind") ;
				...
				{   //change in ada compil a gnat -c
					unparserContent.addOutputNewline("\t$(GCC) -C " +
			...
			{				
		        unparserContent
	              .addOutput("OBJS = main.o subprograms.o activity.o gtypes.o deployment.o ") ;
