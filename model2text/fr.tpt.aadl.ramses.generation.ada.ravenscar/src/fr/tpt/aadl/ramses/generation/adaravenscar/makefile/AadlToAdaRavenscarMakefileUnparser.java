...
public class AadlToAdaRavenscarMakefileUnparser extends
                                               AbstractMakefileUnparser
{

  private final static String _ADA_SUB_PATH =
  ...
  */
  ...
  protected void initSwitches()
  {
    aadl2Switch = new Aadl2Switch<String>()
    {
      ...
      public String caseProcessSubcomponent(ProcessSubcomponent object)
      {
        ...
        unparserContent.addOutputNewline("\tADA_PROJECT_PATH=\"/usr/local/include/ocarina/runtime/polyorb-hi-ada:$$ADA_PROJECT_PATH\" \\") ;
  ...
  private void generateMakefile(NamedElement ne, File makeFile)
  {
  ...
  @Override
  public void process(SystemImplementation system, File runtimePath,
  ...
  @Override
  public void process(ProcessorSubcomponent processor, File runtimePath,
                      File outputDir, File[] includeDirs,
                      IProgressMonitor monitor) throws GenerationException
  {
  ...
  @Override
  public void process(ProcessSubcomponent process, File runtimePath,
                      File outputDir, File[] includeDirs,
                      IProgressMonitor monitor) throws GenerationException
  {
